 ...
 */
@Messages({
    "XLBL_NewFileAction_Name=&New File...",
    "XLBL_NewFileAction_PopupName=New",
    "#{0} Name of the template", "XLBL_NewFileAction_Template_PopupName={0}..."
})
public class NewFile extends ProjectAction implements PropertyChangeListener, Popup {
    ...
    @Messages("XLBL_NewFileAction_Tooltip=New File...")
    public NewFile( Lookup context ) {
        super((String) null, XLBL_NewFileAction_Name(), ImageUtilities.loadImageIcon("org/netbeans/modules/project/ui/resources/newFile.png", false), context);
        putValue("iconBase","org/netbeans/modules/project/ui/resources/newFile.png"); //NOI18N
        putValue(SHORT_DESCRIPTION, XLBL_NewFileAction_Tooltip());
    ...
    protected void refresh(Lookup context, boolean immediate) {
        ...
        Mutex.EVENT.readAccess(new Runnable() {
            public void run() {
                ...
                setDisplayName(XLBL_NewFileAction_Name());
            }
        });
    }
    ...
    public JMenuItem getSubmenuPopupPresenter() {
        if (subMenu == null) {
            subMenu = new JMenu(XLBL_NewFileAction_PopupName());
        }
        return subMenu;
    }
    ...
    @Messages({
        "XLBL_NewFileAction_File_PopupName=Other...",
        "XNewFile.please_wait=Please wait..."
    })
    private void fillSubMenu(final JMenu menuItem, final Project project) {
        menuItem.removeAll();
        JMenuItem wait = new JMenuItem(XNewFile_please_wait());
                    ...
                    @Override public void run() {
                        ...
                        for (TemplateItem i : items) {
                            JMenuItem item = new JMenuItem(
                                    XLBL_NewFileAction_Template_PopupName(i.displayName),
                                    i.icon);
                        ...
                        JMenuItem fileItem = new JMenuItem(XLBL_NewFileAction_File_PopupName(), (Icon) getValue(Action.SMALL_ICON));
    ...
    private void fillNonProjectSubMenu(JMenu menuItem) {
        ...
        for( int i = 0; i < templates.length; i++ ) {
            ...
            JMenuItem item = new JMenuItem(
                    XLBL_NewFileAction_Template_PopupName(n.getDisplayName()),
    ...
    public static final class WithSubMenu extends NewFile {
        ...
        @Override
        public JMenuItem getPopupPresenter() {
            return new DynaMenu(XLBL_NewFileAction_PopupName());
        }
